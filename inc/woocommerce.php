 ...
 * PHP 7.0+ compat — pas de fn() ni de syntaxe 7.4+
 */
...
function chg_ajax_add_to_cart() {
    ...
    if ( ! $product_id ) wp_send_json_error( array( 'message' => 'Produit introuvable.' ) );
    ...
    if ( $added ) {
        ...
        wp_send_json_error( array( 'message' => 'Impossible d\'ajouter ce produit.' ) );
    }
}

// 3 colonnes sur la boutique
add_filter( 'loop_shop_columns', 'chg_loop_shop_columns' );
function chg_loop_shop_columns() {
    return 3;
}
